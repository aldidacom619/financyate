    ...
    <script src="<?php echo  base_url() ?>recursos/bower_components/datatables/media/js/jquery.dataTables.js"></script>
    ...
    <script src="<?php echo  base_url() ?>recursos/bower_components/jquery-validation/jquery.validate.js"></script> 
