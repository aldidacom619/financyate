...
class Pdf2 extends FPDF {
    ...
    public function HeaderTitle($title) {
        ...
        $this->Image(base_url() . 'assets/img/logo.jpg', 7, 3, 40);
        $this->Cell(90);
        $this->Cell(0, -5, 'Empresa de prestamos FINANCYATE', 0, 0, 'R');
        $this->ln(0);
        $this->Cell(40);
        $this->Cell(0, 10, '', 'T');
        if($this->cabecera == 1)
        {
                ...
                $this->Cell(0,0,"(Expresado en: ".utf8_decode($this->moneda.")"),0,0,'C');
                $this->Ln(5);
